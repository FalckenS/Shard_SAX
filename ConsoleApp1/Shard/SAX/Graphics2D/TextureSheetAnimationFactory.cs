...
{
    class TextureSheetAnimationFactory
    {
        private TextureSheet _textureSheet;
        private float _millisecondsBetweenKeyFrames;
        private PlayMode _playMode;
        public TextureSheetAnimationFactory(TextureSheet textureSheet, float millisecondsBetweenKeyFrames, PlayMode playmode)
        {
        ...
        public TextureSheetAnimationFactory(TextureSheet textureSheet, float millisecondsBetweenKeyFrames) :
